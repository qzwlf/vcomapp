 ...
 */
public abstract class PageRecycleViewAdapter<T> extends RecyclerView.Adapter {
    ...
    public PageRecycleViewAdapter(List<T> list, int itemLayout, int footView, Context context, boolean isNeedMore) {
        this.list = list;
